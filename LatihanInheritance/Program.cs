...
namespace LatihanInheritance
{
    class Program
    {
        ...
        {
            Person person = new Person("Farig", 19);
            person.GetNameAndAge();

            Teacher teacher = new Teacher("Soimun", 44, "190345", "Computer Networking");
            teacher.GetNameAndAge();

            Student student = new Student("Farig Maulana Eka Putra", 16, "19.11.2748", "farig.putra@students.amikom.ac.id");
